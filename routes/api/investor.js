...
const investors = [
	new Investor(
		...
		'Male // Drop Down',
		'Egyptian // Drop Down',
		'Individual // Drop Down',
		'National ID // Drop Down',
		'12345678901234',
		'1960-02-23',
		'24 Magnolia St., Compound Le Reve, 6th Of October, Giza, Egypt',
		'01234567890',
		'+20-2-1234567',
		'nagiub.sawiras@mymail.com',
		1000000,
		'Euro // Drop Down'
	),
	new Investor(
		...
		'A823D09H',
		'1970-08-12',
		'324 Gadallah St., Compound Reyan, Abdoun, Amman, Jordan',
		'+962 79 999 9999',
		'+962 6 466 3322',
		'maged.rashad@mymail.com',
		5000000,
		'Dollar // Drop Down'
	),
];
...
router.delete('/delete/:id', (req, res) => {
	...
	if (index < 0)
		return res.status(400).send({ err: 'None of the existing investors has that ID, please check and try again' });
