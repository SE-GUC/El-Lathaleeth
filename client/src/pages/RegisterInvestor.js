    ...
    if (this.props.isEnglish) {
              ...
              <Form onSubmit={this.handleSubmit} noValidate>
                <ul>
                  ...
                  <li>
                    <Form.Group
                      className="address"
                      style={{ marginLeft: "0.0%", width: "100%" }}
                    >
                      <Form.Control
                        className={
                ...
                <div className="createAccount">
                  <Button
                    type="submit"
                    style={{ marginLeft: "-15.0%", width: "25%" }}
                  >
                    Sign Up
                  </Button>
                </div>
      ...
      if (this.state.investorType === "individual") {
        individualRegister = (
          <div>
            <Form.Group className="DateofBirth">
              <Form.Label htmlFor="DateofBirth">تاريخ الميلاد</Form.Label>
              <div />
              <ReactDatez
                name="dateOfBirth"
                handleChange={this.handleDateChange}
            ...
            <Form.Row>
              ...
              <Form.Group className="col-md-6">
                <Form.Label htmlFor="IDNumber">رقم البطاقة</Form.Label>
                <input
                  className={formErrors.IDNumber.length > 0 ? "error" : null}
                  placeholder="IDNumber"
                  type="IDNumber"
      ...
      return (
        <Center>
          <div className="wrRegisterInvestor">
            <div className="form">
              <h1 style={{ marginLeft: "-5.00%", lineHeight: 2.5 }}>
                إشتراك جديد{" "}
              </h1>
              <Form onSubmit={this.handleSubmit} noValidate>
                <ul>
                  <li>
                    <Form.Group className="investorType">
                      ...
                      <Form.Control
                        ...
                        name="investorType"
                      >
                        <option value="">اختر نوع المستثمر</option>
