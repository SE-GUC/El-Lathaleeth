          ...
          <div className="container-fluid">
            <div className="row jumbotron">
              <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
                <p className="lead">
                  This is a jumbotron for el lathaleeth where will be writing
                  any kind of a welcome note/or important news that would
                  motivate the investor to learn more.
                </p>
          ...
          <div className="container-fluid padding">
            <div className="row padding">
              <div className="col-lg-6">
                ...
                <p>
                  ·The Egyptian Economy's resilience is capable of overcoming
                  its economic challenges as it did in the 2008 financial
                  crisis, and long-term investors will see many opportunities.
                </p>
                <p>
                  {" "}
                  ·Egypt has started its transformation to a stable, democratic
                  and modern economy, where the dividends of growth and
                  prosperity will be shared by all who participated in its
                  achievement.
                </p>
                <p>
                  {" "}
                  ·The Egyptian economy's ability to post positive real economic
                  growth rates amid the global economic downturn as well as
                  during the political unrest that prevailed in 2011-2013
                  indicates how resilient economic activity in Egypt.
                </p>
                <br />
                <a
